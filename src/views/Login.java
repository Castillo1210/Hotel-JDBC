...
public class Login extends JFrame {
	...
	private void Login() {
			...
			var validar = this.loginController.validar(txtUsuario.getText(), contrase);
	        ...
	        if(validar){
	            ...
	            JOptionPane.showMessageDialog(this, "Usuario o Contraseña no válidos", "ADVERTENCIA", JOptionPane.WARNING_MESSAGE);
	        }
	} 
