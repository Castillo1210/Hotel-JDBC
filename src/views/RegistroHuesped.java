...
public class RegistroHuesped extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHuesped frame = new RegistroHuesped((long) 0);
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(Long reservasId) {
		...
		txtNreserva.setText(String.valueOf(reservasId));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (txtFechaN.getDate() != null && txtNombre != null && txtApellido != null && txtNacionalidad != null) {
					String fechaNacimiento = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
					var huespedes = new Huespedes(reservasId, txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaNacimiento), (String) txtNacionalidad.getSelectedItem(), txtTelefono.getText());
