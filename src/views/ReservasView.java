		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					var reservas = new Reservas(java.sql.Date.valueOf(fechaEntrada), java.sql.Date.valueOf(fechaSalida), valorTotal, (String) txtFormaPago.getSelectedItem());
					reservasController.guardar(reservas);
					JOptionPane.showMessageDialog(null, "Registro guardado con exito: " + reservas.getId());
					RegistroHuesped registro = new RegistroHuesped(reservas.getId());
